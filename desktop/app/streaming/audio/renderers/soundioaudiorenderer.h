...
{
public:
    explicit SoundIoAudioRenderer(int targetBufferMs = 0);
...
private:
    ...
    double m_Latency;
    int m_TargetBufferMs;
    int m_TargetFrames;
    bool m_Primed;
    std::uint64_t m_UnderrunCount;
    std::uint64_t m_SilenceFrames;
    std::uint32_t m_LastBufferLogTime;
    bool m_Errored;
};
